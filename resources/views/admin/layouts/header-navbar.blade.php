                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item"><a class="submenu-link" href="resetPassword">Reset
                                        password</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="page404">404 page</a>
                                        </li>
                                        <li class="submenu-item"><a class="submenu-link" href="admin">Logout</a>
                                        </li>
                                </ul>
                            </div>
                        </li><!--//nav-item-->
