                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                    ...
                                    <li><a class="dropdown-item" href="nulll">Log Out</a></li>
                                </ul>
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="index.html"><img class="logo-icon me-2"
                            src="{{asset('assets/images/app-logo.svg')}}" alt="logo"><span class="logo-text">PORTAL</span></a>
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item"><a class="submenu-link" href="account">Account</a></li>
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item"><a class="submenu-link" href="nulll">Reset
                                        password</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="nulll">404 page</a>
                                        </li>
                                        <li class="submenu-item"><a class="submenu-link" href="nulll">Logout</a>
                                        </li>
                                </ul>
                            </div>
                        </li><!--//nav-item-->
